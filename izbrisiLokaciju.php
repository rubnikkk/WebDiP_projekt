...
$upit = "DELETE FROM lokacija_benzinske_postaje WHERE id_lokacije_benzinske_postaje = '$id_lokacije'";
$rezultat = $baza->selectDB($upit);

$zapis="Obrisana je lokacija";
...
<body>
    ...
    <br>
    <a href="pregledLokacija.php">Natrag</a>

    <div id="greske">
        <div id="phpGreske">
            <div class="zadnji">  
                Lokacija je izbrisana!
            </div>            
        </div>
    </div>
