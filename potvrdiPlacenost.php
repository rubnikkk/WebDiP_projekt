...
$upit = "UPDATE mjesto_na_benzinskoj SET status_mjesta='otvorena' WHERE id_mjesta = '$id_mjesta'";
...
<head>
    <title>Potvrđivanje plaćenosti</title>
    <meta charset="utf-8">
...
<body>
    ...
    <br>
    <a href="pregledSvihMjesta.php">Popis mjesta</a>
