...
$tablica = "<table style='width:50%'><tr><th>ID korisnika</th><th>Uloga</th><th>Ime</th><th>Prezime</th><th>Lozinka</th></tr>\n";
...
while (list($id_korisnika,$id_uloge,$ime,$prezime,$lozinka) = $rezultat->fetch_array()){
    ...
    $tablica.= "<tr><td>$id_korisnika</td><td>$id_uloge</td><td>$ime</td><td>$prezime</td><td>$lozinka</td><td><a href='zakljucajKorisnika.php?id=$id_korisnika'>Zaključaj</a></tr>\n";
}
...
<body>
    ...
    <h2>Popis otključanih računa</h2>
    <?php
        echo $tablica;
    ?>
