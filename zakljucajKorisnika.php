...
$upit = "UPDATE korisnik SET status=0 WHERE id_korisnika = '$id_korisnika'";
...
<body>
    ...
    <br>
    <a href="zakljucajRacun.php">Natrag</a>
    <br>
    <a href="otkljucajRacun.php">Popis zaključanih računa</a>
