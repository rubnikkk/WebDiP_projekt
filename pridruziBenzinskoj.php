...
$tablica = "<table style='width:50%'><tr><th>ID vrste</th><th>Naziv</th><th>Dobavljač</th></tr>\n";

while (list($id_vrste_goriva,$naziv_vrste,$dobavljac) = $rezultat->fetch_array()){
    $tablica.= "<tr><td>$id_vrste_goriva</td><td>$naziv_vrste</td><td>$dobavljac</td><td><a href='dodajGorivoBenzinskoj.php?id=$id_vrste_goriva'>Pridruži postaji</a></td></tr>\n";
}
